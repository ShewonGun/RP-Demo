        ...
        <div>
            ...
            <div className="mt-5 rounded-sm border border-slate-200 bg-white p-5 dark:border-slate-800 dark:bg-slate-900">
                <div className="flex items-center justify-between gap-3">
                    <div>
                        <p className="text-sm font-semibold text-slate-900 dark:text-white">Zone monitoring</p>
                        <p className="mt-0.5 text-xs text-slate-500 dark:text-slate-400">Open the highlighted zone for field investigation.</p>
                    </div>
                    <Link to="/zone/07" className="inline-flex items-center gap-1.5 rounded-md bg-sky-600 px-3 py-2 text-xs font-medium text-white transition hover:bg-sky-700">
                        Open Zone 07 <FiArrowRight className="h-3.5 w-3.5" />
                    </Link>
                </div>
                <div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-3">
                    <ZoneLinkCard title="Zone 07" subtitle="High risk investigation" tone="red" to="/zone/07" />
                    <ZoneLinkCard title="Pressure" subtitle="Behavior tracking" tone="sky" to="/pressure" />
                    <ZoneLinkCard title="Alerts" subtitle="Investigations queue" tone="emerald" to="/alerts" />
                </div>
            </div>
...
const ZoneLinkCard = ({ title, subtitle, tone, to }) => {
    const tones = {
    ...
    return (
        <Link to={to} className="rounded-md border border-slate-200 bg-slate-50 p-4 transition hover:border-sky-300 hover:bg-white dark:border-slate-800 dark:bg-slate-950 dark:hover:border-sky-700 dark:hover:bg-slate-900">
            <span className={`inline-flex rounded-md px-2 py-1 text-[11px] font-semibold ${tones[tone]}`}>{title}</span>
            <p className="mt-3 text-sm font-medium text-slate-900 dark:text-white">{subtitle}</p>
        </Link>
    );
};
